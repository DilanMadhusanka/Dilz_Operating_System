;Dilz Os --- The Dilz Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE DIL_OS_VER '1.0.0'	 ;OS version number
	%DEFINE DIL_OS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as DIL_OS and its programs
...
option_screen:
	...
	mov cx, 01101011b		; Colour: brown text on light cyan
	...
	os_init_msg		db '*************************Welcome to Dilz OS****************************', 0
	os_version_msg		db 'Version ', DIL_OS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', DIL_OS_VER, 0

	dialog_string_1		db 'Welcome to Dilz Operating System', 0
	dialog_string_2		db 'Please select Show for HardwareInfo or', 0
